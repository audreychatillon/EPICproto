...
public:
  ...
  inline void SetHitFC(const short &ID, const double &q1, const double &q2,
                       const double &q3, const double &fq2, const double &rawt,
                       const double &qmax, const double &inE, const double &Tof,
                       const double Timehf, const bool &isFakeFission,
                       const double &cfd) {
