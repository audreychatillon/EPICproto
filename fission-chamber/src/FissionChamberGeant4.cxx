...
namespace fission_chamber {
 const string Material = "BC400";
  ...
  FissionChamberGeant4::FissionChamberGeant4() {
    nptool::message("green", "fission_chamber", "FissionChamberGeant4", "Initializing simulation");
    m_detector = std::dynamic_pointer_cast<fission_chamber::FissionChamberDetector>(
        nptool::Application::GetApplication()->GetDetector("fission_chamber"));
...
G4LogicalVolume* FissionChamber::BuildSensitiveCell(){
  ...
  if(!m_SensitiveCell){
    G4Tubs* scin_cell = new G4Tubs("FissionChamber_scin", 0, FissionChamber_NS::Radius, FissionChamber_NS::Thickness*0.5, 0., 360*deg);
    m_SensitiveCell = new G4LogicalVolume(scin_cell,m_EJ309,"logic_FissionChamber_scin",0,0,0);
  ...
  */
  ...
  void FissionChamberGeant4::ConstructDetector() {
    nptool::message("green", "fission_chamber", "FissionChamberGeant4", "Constructing Geometry");
  ...
  void FissionChamberGeant4::ReadSensitive(const G4Event*) {
    m_Event->Clear();
  }
