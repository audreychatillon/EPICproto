...
// #include "FissionChamberGeant4.hh"
...
FissionChamberGeant4::FissionChamberGeant4() {
  nptool::message("green", "fission_chamber", "FissionChamberGeant4",
                  "Initializing simulation");
  m_detector =
      std::dynamic_pointer_cast<fission_chamber::FissionChamberDetector>(
          nptool::Application::GetApplication()->GetDetector(
              "fission_chamber"));

  m_Event = new fission_chamber::FissionChamberData();
  ...
  // m_EJ309   =
  // MaterialManager::getInstance()->GetMaterialFromLibrary("EJ309"); m_EJ560 =
  // MaterialManager::getInstance()->GetMaerialFromLibrary("EJ560"); m_Pyrex   =
  // MaterialManager::getInstance()->GetMaterialFromLibrary("Pyrex"); m_MuMetal
  // = MaterialManager::getInstance()->GetMaterialFromLibrary("mumetal");
}
////////////////////////////////////////////////////////////////////////////////
FissionChamberGeant4::~FissionChamberGeant4() {}
////////////////////////////////////////////////////////////////////////////////
/*
G4LogicalVolume* FissionChamber::BuildSensitiveCell(){

  if(!m_SensitiveCell){
    G4Tubs* scin_cell = new G4Tubs("FissionChamber_scin", 0,
FissionChamber_NS::Radius, FissionChamber_NS::Thickness*0.5, 0., 360*deg);
    m_SensitiveCell = new
G4LogicalVolume(scin_cell,m_EJ309,"logic_FissionChamber_scin",0,0,0);
    m_SensitiveCell->SetVisAttributes(m_VisEJ309);
   // m_SensitiveCell->SetSensitiveDetector(m_FissionChamberScorer);
  }
...
void FissionChamberGeant4::ConstructDetector() {
  nptool::message("green", "fission_chamber", "FissionChamberGeant4",
...
void FissionChamberGeant4::ReadSensitive(const G4Event *) { m_Event->Clear(); }

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
////////////////////////////////////////////////////////////////
void FissionChamberGeant4::InitializeScorers() {}
////////////////////////////////////////////////////////////////////////////////
extern "C" {
std::shared_ptr<nptool::geant4::VDetector> ConstructDetectorSimulation() {
  return make_shared<fission_chamber::FissionChamberGeant4>();
};
}
} // namespace fission_chamber
