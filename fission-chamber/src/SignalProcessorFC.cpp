...
SignalProcessorFC::SignalProcessorFC(const std::vector<double>& inputSamples, bool applyFilter_ =false) : samples(inputSamples), applyFilter(applyFilter_) {}
...
double SignalProcessorFC::calculateCFD(const double fract, const int delay, const int dt, double &Qmax, int &iQmax, int &imax, double &Q_CFD_min, bool &Triggered, bool &Threshold) {
...
double SignalProcessorFC::integrateSignal(int binWidth, double startTime, double endTime) {
